...
import { WAMessageStatusUpdate, WAMessage, WAChat, WA_MESSAGE_STATUS_TYPE, PresenceUpdate, FazoneEvent, DisconnectReason, WAOpenResult, AuthenticationCredentials } from './Constants';
export declare class WAConnection extends Base {
    ...
    emit(event: FazoneEvent | string, ...args: any[]): boolean;
}
