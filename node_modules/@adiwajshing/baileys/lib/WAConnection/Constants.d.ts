...
export declare class FazoneError extends Error {
    status?: number;
    context: any;
    constructor(message: string, context: any);
}
export declare const TimedOutError: () => FazoneError;
export declare const CancelledError: () => FazoneError;
...
export declare type FazoneEvent = 'open' | 'connecting' | 'close' | 'intermediate-close' | 'qr' | 'connection-phone-change' | 'user-presence-update' | 'user-status-update' | 'chat-new' | 'chat-update' | 'message-new' | 'message-update' | 'message-status-update' | 'group-participants-add' | 'group-participants-remove' | 'group-participants-promote' | 'group-participants-demote' | 'group-settings-update' | 'group-description-update' | 'received-pong' | 'credentials-updated' | 'connection-validated';
