...
class WAConnection extends _5_User_1.WAConnection {
        ...
        switch (type) {
            ...
            case Constants_1.MessageType.extendedText:
                ...
                if ('text' in message) {
                    ...
                    throw new Constants_1.FazoneError('message needs to be a string or object with property \'text\'', message);
                }
                break;
    ...
    async updateMediaMessage(message) {
        ...
        if (!content)
            throw new Constants_1.FazoneError(`given message ${message.key.id} is not a media message`, message);
    ...
    async downloadMediaMessage(message) {
        try {
            ...
            if (error instanceof Constants_1.FazoneError && error.status === 404) { // media needs to be updated
